...
<p align="left"> In order to find the best possible model, several different neural network structures were test.  Figure 1 below demonstrates how the models performed with respect to the accuracy metric on the test set.
</p>
